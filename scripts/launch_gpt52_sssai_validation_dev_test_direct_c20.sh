...
export NLRL_EXECUTOR_TIMEOUT_SECONDS="${NLRL_EXECUTOR_TIMEOUT_SECONDS:-420}"
export NLRL_EXECUTOR_ENABLE_THINKING="${NLRL_EXECUTOR_ENABLE_THINKING:-1}"
export NLRL_EXECUTOR_REASONING_EFFORT="${NLRL_EXECUTOR_REASONING_EFFORT:-xhigh}"
...
echo "NLRL_EXECUTOR_REASONING_EFFORT=${NLRL_EXECUTOR_REASONING_EFFORT}"

run_split() {
  local split_label="$1"
  local dataset="$2"
  local count_label="$3"
  local run_name="${RUN_PREFIX}_gaia_${split_label}${count_label}_direct_gpt52_sssai_c20_noskill"
