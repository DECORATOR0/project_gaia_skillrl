...
- Preserve working behavior and keep the long BOOT-V6 node-local guidance useful for `Qwen3.5-9B-local`.
- When editing `Rules`, preserve or increase substantive phase-local guidance. Do not compress a phase below the BOOT-V6 target of roughly 1000-1500 words unless the critic evidence clearly shows that specific text is harmful.
